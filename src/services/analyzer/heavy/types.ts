...
export type TargetType =
  | 'TG_CHANNEL' | 'TG_GROUP' | 'TG_PROFILE' | 'TG_POST' | 'TG_STORY' | 'TG_BOT' | 'TG_BOOST' | 'TG_PROXY' | 'TG_FOLDER' | 'TG_INVOICE' | 'TG_INVITE' | 'TG_STARS'
  | 'VK_PROFILE' | 'VK_GROUP' | 'VK_WALL' | 'VK_POST' | 'VK_VIDEO' | 'VK_CLIP' | 'VK_PLAYLIST' | 'VK_PHOTO' | 'VK_PLAY' | 'VK_PLAY_CHANNEL' | 'VK_PLAY_LIVE' | 'VK_APP' | 'VK_PODCAST' | 'VK_AUDIO' | 'VK_CALL'
  | 'VK_TOPIC' | 'VK_ARTICLE' | 'VK_NARRATIVE' | 'VK_STORY' | 'VK_POLL' | 'VK_COMMENT' | 'VK_ALBUM' | 'VK_MARKET' | 'VK_DM'
  | 'IG_PROFILE' | 'IG_POST' | 'IG_REEL' | 'IG_STORY' | 'IG_HIGHLIGHT' | 'IG_GUIDE' | 'IG_AUDIO' | 'IG_EFFECT' | 'IG_IGTV'
  | 'YT_CHANNEL' | 'YT_VIDEO' | 'YT_SHORTS' | 'YT_LIVE' | 'YT_PLAYLIST' | 'YT_COMMUNITY' | 'YT_COMMENT' | 'YT_POST'
